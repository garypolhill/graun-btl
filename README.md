...
| --- | --- | --- | --- | --- | --- | --- |
| e.g. `GUC001` | `NA` if not a response | e.g. `GUU001` | [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format | Number of 'upticks' | `1` if highlighted by editor, `0` if not | Text with any HTML markup |
